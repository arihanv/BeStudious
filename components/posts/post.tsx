...
export default function Post({
  ...
  const differenceInHours = currentTime.diff(postedTime, "hours")
  const differenceInDays = currentTime.diff(postedTime, "days")
  const differenceInWeeks = currentTime.diff(postedTime, "weeks")

  let timeUnit, timeDiff

  if (differenceInWeeks >= 1) {
    timeDiff = differenceInWeeks
    timeUnit = "w"
