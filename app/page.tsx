...
import { Contact, GraduationCap, Medal, Play, Rss, Users } from "lucide-react"
...
export default function IndexPage() {
  ...
  return (
    <section className="container flex h-full flex-col items-center justify-center gap-10 pb-8 pt-6 md:py-10">
      ...
      <div className="flex h-full w-full max-w-[480px] flex-col items-center justify-center gap-3 pb-20 tracking-tight">
        ...
        <div className="grid w-full grid-cols-3 gap-2">
          ...
          <Link
            href="https://www.youtube.com/watch?v=LqrgWfMvolo"
            className={twMerge(buttonVariants(), "w-full")}
            style={{ color: "#f8fafc", backgroundColor: "#1a1a1a" }}
          >
            <div className="flex items-center gap-1.5">
              <Play width={15} /> Demo Video
            </div>
          </Link>
        </div>
      </div>
